...
#ifndef __astroSim_dadddsubeOg__HH__
#define __astroSim_dadddsubeOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_dadddsubeOg) {
    ...
    SC_CTOR(astroSim_dadddsubeOg):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
