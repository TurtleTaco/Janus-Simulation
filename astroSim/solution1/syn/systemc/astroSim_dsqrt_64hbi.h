...
#ifndef __astroSim_dsqrt_64hbi__HH__
#define __astroSim_dsqrt_64hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_dsqrt_64hbi) {
    ...
    SC_CTOR(astroSim_dsqrt_64hbi):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
