...
#ifndef __astroSim_sitodp_6eOg__HH__
#define __astroSim_sitodp_6eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_sitodp_6eOg) {
    ...
    SC_CTOR(astroSim_sitodp_6eOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
