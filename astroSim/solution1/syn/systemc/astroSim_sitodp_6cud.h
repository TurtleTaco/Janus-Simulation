...
#ifndef __astroSim_sitodp_6cud__HH__
#define __astroSim_sitodp_6cud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_sitodp_6cud) {
    ...
    SC_CTOR(astroSim_sitodp_6cud):  ACMP_sitodp_U ("ACMP_sitodp_U") {
