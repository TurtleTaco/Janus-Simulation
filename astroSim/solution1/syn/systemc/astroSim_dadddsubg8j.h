...
#ifndef __astroSim_dadddsubg8j__HH__
#define __astroSim_dadddsubg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_dadddsubg8j) {
    ...
    ACMP_dadddsub<ID, 4, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_dadddsub_U;

    SC_CTOR(astroSim_dadddsubg8j):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
