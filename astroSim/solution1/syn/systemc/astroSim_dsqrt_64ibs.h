...
#ifndef __astroSim_dsqrt_64ibs__HH__
#define __astroSim_dsqrt_64ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_dsqrt_64ibs) {
    ...
    SC_CTOR(astroSim_dsqrt_64ibs):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
