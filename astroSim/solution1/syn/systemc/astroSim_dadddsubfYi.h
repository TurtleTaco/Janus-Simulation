...
#ifndef __astroSim_dadddsubfYi__HH__
#define __astroSim_dadddsubfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(astroSim_dadddsubfYi) {
    ...
    SC_CTOR(astroSim_dadddsubfYi):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
