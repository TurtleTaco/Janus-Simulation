...
; <label>:13                                      ; preds = %9
  ...
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 10, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !246 ; [debug line = 157:1]
  %14 = getelementptr inbounds [9 x %struct.reb_particle_int]* %p_int, i32 0, i32 0, !dbg !247 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 158:2]
  %15 = load double* %dt, align 8, !dbg !247      ; [#uses=1 type=double] [debug line = 158:2]
  %16 = getelementptr inbounds [9 x %struct.reb_particle]* %p, i32 0, i32 0, !dbg !247 ; [#uses=1 type=%struct.reb_particle*] [debug line = 158:2]
  call void @janus_step(%struct.reb_particle_int* %14, double %15, %struct.reb_particle* %16), !dbg !247 ; [debug line = 158:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([7 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !248 ; [debug line = 159:5]
  br label %17, !dbg !248                         ; [debug line = 159:5]

; <label>:17                                      ; preds = %13
  %18 = load i32* %t, align 4, !dbg !249          ; [#uses=1 type=i32] [debug line = 155:68]
  %19 = add nsw i32 %18, 1, !dbg !249             ; [#uses=1 type=i32] [debug line = 155:68]
  store i32 %19, i32* %t, align 4, !dbg !249      ; [debug line = 155:68]
  br label %9, !dbg !249                          ; [debug line = 155:68]

; <label>:20                                      ; preds = %9
  %21 = load %struct.reb_particle** %1, align 8, !dbg !250 ; [#uses=1 type=%struct.reb_particle*] [debug line = 160:5]
  %22 = bitcast %struct.reb_particle* %21 to i8*, !dbg !250 ; [#uses=1 type=i8*] [debug line = 160:5]
  %23 = getelementptr inbounds [9 x %struct.reb_particle]* %p, i32 0, i32 0, !dbg !250 ; [#uses=1 type=%struct.reb_particle*] [debug line = 160:5]
  %24 = bitcast %struct.reb_particle* %23 to i8*, !dbg !250 ; [#uses=1 type=i8*] [debug line = 160:5]
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %22, i8* %24, i64 720, i32 8, i1 false), !dbg !250 ; [debug line = 160:5]
  ret void, !dbg !251                             ; [debug line = 161:1]
}
...
define internal void @to_int(%struct.reb_particle_int* %p_int, %struct.reb_particle* %p) nounwind uwtable {
  ...
  %i = alloca i32, align 4                        ; [#uses=16 type=i32*]
  store %struct.reb_particle_int* %p_int, %struct.reb_particle_int** %1, align 8
  call void @llvm.dbg.declare(metadata !{%struct.reb_particle_int** %1}, metadata !252), !dbg !253 ; [debug line = 11:45] [debug variable = p_int]
  store %struct.reb_particle* %p, %struct.reb_particle** %2, align 8
  call void @llvm.dbg.declare(metadata !{%struct.reb_particle** %2}, metadata !254), !dbg !255 ; [debug line = 11:73] [debug variable = p]
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !256), !dbg !259 ; [debug line = 12:22] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !260        ; [debug line = 12:25]
  br label %3, !dbg !260                          ; [debug line = 12:25]

; <label>:3                                       ; preds = %85, %0
  %4 = load i32* %i, align 4, !dbg !260           ; [#uses=1 type=i32] [debug line = 12:25]
  %5 = icmp ult i32 %4, 9, !dbg !260              ; [#uses=1 type=i1] [debug line = 12:25]
  br i1 %5, label %6, label %88, !dbg !260        ; [debug line = 12:25]

; <label>:6                                       ; preds = %3
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !261 ; [debug line = 12:37]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 3, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !263 ; [debug line = 13:1]
  %7 = load i32* %i, align 4, !dbg !264           ; [#uses=1 type=i32] [debug line = 14:2]
  %8 = zext i32 %7 to i64, !dbg !264              ; [#uses=1 type=i64] [debug line = 14:2]
  %9 = load %struct.reb_particle** %2, align 8, !dbg !264 ; [#uses=1 type=%struct.reb_particle*] [debug line = 14:2]
  %10 = getelementptr inbounds %struct.reb_particle* %9, i64 %8, !dbg !264 ; [#uses=1 type=%struct.reb_particle*] [debug line = 14:2]
  %11 = getelementptr inbounds %struct.reb_particle* %10, i32 0, i32 0, !dbg !264 ; [#uses=1 type=double*] [debug line = 14:2]
  %12 = load double* %11, align 8, !dbg !264      ; [#uses=1 type=double] [debug line = 14:2]
  %13 = fdiv double %12, 1.000000e-16, !dbg !264  ; [#uses=1 type=double] [debug line = 14:2]
  %14 = fptosi double %13 to i64, !dbg !264       ; [#uses=1 type=i64] [debug line = 14:2]
  %15 = load i32* %i, align 4, !dbg !264          ; [#uses=1 type=i32] [debug line = 14:2]
  %16 = zext i32 %15 to i64, !dbg !264            ; [#uses=1 type=i64] [debug line = 14:2]
  %17 = load %struct.reb_particle_int** %1, align 8, !dbg !264 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 14:2]
  %18 = getelementptr inbounds %struct.reb_particle_int* %17, i64 %16, !dbg !264 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 14:2]
  %19 = getelementptr inbounds %struct.reb_particle_int* %18, i32 0, i32 0, !dbg !264 ; [#uses=1 type=i64*] [debug line = 14:2]
  store i64 %14, i64* %19, align 8, !dbg !264     ; [debug line = 14:2]
  %20 = load i32* %i, align 4, !dbg !265          ; [#uses=1 type=i32] [debug line = 15:9]
  %21 = zext i32 %20 to i64, !dbg !265            ; [#uses=1 type=i64] [debug line = 15:9]
  %22 = load %struct.reb_particle** %2, align 8, !dbg !265 ; [#uses=1 type=%struct.reb_particle*] [debug line = 15:9]
  %23 = getelementptr inbounds %struct.reb_particle* %22, i64 %21, !dbg !265 ; [#uses=1 type=%struct.reb_particle*] [debug line = 15:9]
  %24 = getelementptr inbounds %struct.reb_particle* %23, i32 0, i32 1, !dbg !265 ; [#uses=1 type=double*] [debug line = 15:9]
  %25 = load double* %24, align 8, !dbg !265      ; [#uses=1 type=double] [debug line = 15:9]
  %26 = fdiv double %25, 1.000000e-16, !dbg !265  ; [#uses=1 type=double] [debug line = 15:9]
  %27 = fptosi double %26 to i64, !dbg !265       ; [#uses=1 type=i64] [debug line = 15:9]
  %28 = load i32* %i, align 4, !dbg !265          ; [#uses=1 type=i32] [debug line = 15:9]
  %29 = zext i32 %28 to i64, !dbg !265            ; [#uses=1 type=i64] [debug line = 15:9]
  %30 = load %struct.reb_particle_int** %1, align 8, !dbg !265 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 15:9]
  %31 = getelementptr inbounds %struct.reb_particle_int* %30, i64 %29, !dbg !265 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 15:9]
  %32 = getelementptr inbounds %struct.reb_particle_int* %31, i32 0, i32 1, !dbg !265 ; [#uses=1 type=i64*] [debug line = 15:9]
  store i64 %27, i64* %32, align 8, !dbg !265     ; [debug line = 15:9]
  %33 = load i32* %i, align 4, !dbg !266          ; [#uses=1 type=i32] [debug line = 16:9]
  %34 = zext i32 %33 to i64, !dbg !266            ; [#uses=1 type=i64] [debug line = 16:9]
  %35 = load %struct.reb_particle** %2, align 8, !dbg !266 ; [#uses=1 type=%struct.reb_particle*] [debug line = 16:9]
  %36 = getelementptr inbounds %struct.reb_particle* %35, i64 %34, !dbg !266 ; [#uses=1 type=%struct.reb_particle*] [debug line = 16:9]
  %37 = getelementptr inbounds %struct.reb_particle* %36, i32 0, i32 2, !dbg !266 ; [#uses=1 type=double*] [debug line = 16:9]
  %38 = load double* %37, align 8, !dbg !266      ; [#uses=1 type=double] [debug line = 16:9]
  %39 = fdiv double %38, 1.000000e-16, !dbg !266  ; [#uses=1 type=double] [debug line = 16:9]
  %40 = fptosi double %39 to i64, !dbg !266       ; [#uses=1 type=i64] [debug line = 16:9]
  %41 = load i32* %i, align 4, !dbg !266          ; [#uses=1 type=i32] [debug line = 16:9]
  %42 = zext i32 %41 to i64, !dbg !266            ; [#uses=1 type=i64] [debug line = 16:9]
  %43 = load %struct.reb_particle_int** %1, align 8, !dbg !266 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 16:9]
  %44 = getelementptr inbounds %struct.reb_particle_int* %43, i64 %42, !dbg !266 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 16:9]
  %45 = getelementptr inbounds %struct.reb_particle_int* %44, i32 0, i32 2, !dbg !266 ; [#uses=1 type=i64*] [debug line = 16:9]
  store i64 %40, i64* %45, align 8, !dbg !266     ; [debug line = 16:9]
  %46 = load i32* %i, align 4, !dbg !267          ; [#uses=1 type=i32] [debug line = 17:9]
  %47 = zext i32 %46 to i64, !dbg !267            ; [#uses=1 type=i64] [debug line = 17:9]
  %48 = load %struct.reb_particle** %2, align 8, !dbg !267 ; [#uses=1 type=%struct.reb_particle*] [debug line = 17:9]
  %49 = getelementptr inbounds %struct.reb_particle* %48, i64 %47, !dbg !267 ; [#uses=1 type=%struct.reb_particle*] [debug line = 17:9]
  %50 = getelementptr inbounds %struct.reb_particle* %49, i32 0, i32 3, !dbg !267 ; [#uses=1 type=double*] [debug line = 17:9]
  %51 = load double* %50, align 8, !dbg !267      ; [#uses=1 type=double] [debug line = 17:9]
  %52 = fdiv double %51, 1.000000e-16, !dbg !267  ; [#uses=1 type=double] [debug line = 17:9]
  %53 = fptosi double %52 to i64, !dbg !267       ; [#uses=1 type=i64] [debug line = 17:9]
  %54 = load i32* %i, align 4, !dbg !267          ; [#uses=1 type=i32] [debug line = 17:9]
  %55 = zext i32 %54 to i64, !dbg !267            ; [#uses=1 type=i64] [debug line = 17:9]
  %56 = load %struct.reb_particle_int** %1, align 8, !dbg !267 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 17:9]
  %57 = getelementptr inbounds %struct.reb_particle_int* %56, i64 %55, !dbg !267 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 17:9]
  %58 = getelementptr inbounds %struct.reb_particle_int* %57, i32 0, i32 3, !dbg !267 ; [#uses=1 type=i64*] [debug line = 17:9]
  store i64 %53, i64* %58, align 8, !dbg !267     ; [debug line = 17:9]
  %59 = load i32* %i, align 4, !dbg !268          ; [#uses=1 type=i32] [debug line = 18:9]
  %60 = zext i32 %59 to i64, !dbg !268            ; [#uses=1 type=i64] [debug line = 18:9]
  %61 = load %struct.reb_particle** %2, align 8, !dbg !268 ; [#uses=1 type=%struct.reb_particle*] [debug line = 18:9]
  %62 = getelementptr inbounds %struct.reb_particle* %61, i64 %60, !dbg !268 ; [#uses=1 type=%struct.reb_particle*] [debug line = 18:9]
  %63 = getelementptr inbounds %struct.reb_particle* %62, i32 0, i32 4, !dbg !268 ; [#uses=1 type=double*] [debug line = 18:9]
  %64 = load double* %63, align 8, !dbg !268      ; [#uses=1 type=double] [debug line = 18:9]
  %65 = fdiv double %64, 1.000000e-16, !dbg !268  ; [#uses=1 type=double] [debug line = 18:9]
  %66 = fptosi double %65 to i64, !dbg !268       ; [#uses=1 type=i64] [debug line = 18:9]
  %67 = load i32* %i, align 4, !dbg !268          ; [#uses=1 type=i32] [debug line = 18:9]
  %68 = zext i32 %67 to i64, !dbg !268            ; [#uses=1 type=i64] [debug line = 18:9]
  %69 = load %struct.reb_particle_int** %1, align 8, !dbg !268 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 18:9]
  %70 = getelementptr inbounds %struct.reb_particle_int* %69, i64 %68, !dbg !268 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 18:9]
  %71 = getelementptr inbounds %struct.reb_particle_int* %70, i32 0, i32 4, !dbg !268 ; [#uses=1 type=i64*] [debug line = 18:9]
  store i64 %66, i64* %71, align 8, !dbg !268     ; [debug line = 18:9]
  %72 = load i32* %i, align 4, !dbg !269          ; [#uses=1 type=i32] [debug line = 19:9]
  %73 = zext i32 %72 to i64, !dbg !269            ; [#uses=1 type=i64] [debug line = 19:9]
  %74 = load %struct.reb_particle** %2, align 8, !dbg !269 ; [#uses=1 type=%struct.reb_particle*] [debug line = 19:9]
  %75 = getelementptr inbounds %struct.reb_particle* %74, i64 %73, !dbg !269 ; [#uses=1 type=%struct.reb_particle*] [debug line = 19:9]
  %76 = getelementptr inbounds %struct.reb_particle* %75, i32 0, i32 5, !dbg !269 ; [#uses=1 type=double*] [debug line = 19:9]
  %77 = load double* %76, align 8, !dbg !269      ; [#uses=1 type=double] [debug line = 19:9]
  %78 = fdiv double %77, 1.000000e-16, !dbg !269  ; [#uses=1 type=double] [debug line = 19:9]
  %79 = fptosi double %78 to i64, !dbg !269       ; [#uses=1 type=i64] [debug line = 19:9]
  %80 = load i32* %i, align 4, !dbg !269          ; [#uses=1 type=i32] [debug line = 19:9]
  %81 = zext i32 %80 to i64, !dbg !269            ; [#uses=1 type=i64] [debug line = 19:9]
  %82 = load %struct.reb_particle_int** %1, align 8, !dbg !269 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 19:9]
  %83 = getelementptr inbounds %struct.reb_particle_int* %82, i64 %81, !dbg !269 ; [#uses=1 type=%struct.reb_particle_int*] [debug line = 19:9]
  %84 = getelementptr inbounds %struct.reb_particle_int* %83, i32 0, i32 5, !dbg !269 ; [#uses=1 type=i64*] [debug line = 19:9]
  store i64 %79, i64* %84, align 8, !dbg !269     ; [debug line = 19:9]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !270 ; [debug line = 20:5]
  br label %85, !dbg !270                         ; [debug line = 20:5]

; <label>:85                                      ; preds = %6
  %86 = load i32* %i, align 4, !dbg !271          ; [#uses=1 type=i32] [debug line = 12:32]
  %87 = add i32 %86, 1, !dbg !271                 ; [#uses=1 type=i32] [debug line = 12:32]
  store i32 %87, i32* %i, align 4, !dbg !271      ; [debug line = 12:32]
  br label %3, !dbg !271                          ; [debug line = 12:32]

; <label>:88                                      ; preds = %3
  ret void, !dbg !272                             ; [debug line = 21:1]
}
...
!246 = metadata !{i32 157, i32 1, metadata !245, null}
!247 = metadata !{i32 158, i32 2, metadata !245, null}
!248 = metadata !{i32 159, i32 5, metadata !245, null}
!249 = metadata !{i32 155, i32 68, metadata !243, null}
!250 = metadata !{i32 160, i32 5, metadata !222, null}
!251 = metadata !{i32 161, i32 1, metadata !222, null}
!252 = metadata !{i32 786689, metadata !40, metadata !"p_int", metadata !6, i32 16777227, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!253 = metadata !{i32 11, i32 45, metadata !40, null}
!254 = metadata !{i32 786689, metadata !40, metadata !"p", metadata !6, i32 33554443, metadata !22, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!255 = metadata !{i32 11, i32 73, metadata !40, null}
!256 = metadata !{i32 786688, metadata !257, metadata !"i", metadata !6, i32 12, metadata !56, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!257 = metadata !{i32 786443, metadata !258, i32 12, i32 5, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!258 = metadata !{i32 786443, metadata !40, i32 11, i32 75, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!259 = metadata !{i32 12, i32 22, metadata !257, null}
!260 = metadata !{i32 12, i32 25, metadata !257, null}
!261 = metadata !{i32 12, i32 37, metadata !262, null}
!262 = metadata !{i32 786443, metadata !257, i32 12, i32 36, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!263 = metadata !{i32 13, i32 1, metadata !262, null}
!264 = metadata !{i32 14, i32 2, metadata !262, null}
!265 = metadata !{i32 15, i32 9, metadata !262, null}
!266 = metadata !{i32 16, i32 9, metadata !262, null}
!267 = metadata !{i32 17, i32 9, metadata !262, null}
!268 = metadata !{i32 18, i32 9, metadata !262, null}
!269 = metadata !{i32 19, i32 9, metadata !262, null}
!270 = metadata !{i32 20, i32 5, metadata !262, null}
!271 = metadata !{i32 12, i32 32, metadata !257, null}
!272 = metadata !{i32 21, i32 1, metadata !258, null}
